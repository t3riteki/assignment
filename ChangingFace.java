...
public class ChangingFace extends Application {
    ...
    public void start(Stage stage) {
        ...
        Arc mouth = new Arc(125, 135, 45, 35, 0, -180);
        mouth.setFill(Color.YELLOW);
        mouth.setStroke(Color.BLACK);
        mouth.setType(ArcType.OPEN);
        
        // create and configure the text
        Text caption = new Text(68, 240, "");
        ...
        // Agi sa kainit sa davao
        
        Button walkButton = new Button("Enter Davao");
        ...
        buttonBox.getChildren().addAll(smileButton, frownButton, walkButton);
        ...
        mouth.setLength(-180);
        mouth.setFill(null);
        caption.setText("Nakakaon og Ice Cream");
        });
        ...
        mouth.setLength(180);
        mouth.setFill(null);
        caption.setText("Katamak og lansang");
        });

        
        walkButton.setOnAction(e -> {
            face.setFill(Color.BROWN);
            mouth.setLength(-360);
            mouth.setFill(Color.PINK);
            caption.setText("Atay");
            });
       
        // add the scene to the stage, then set the title
        stage.setScene(scene);
        stage.setTitle("Changing Face By Gabriel Antonio Y. de Guzman");
